...
import {  faCloudArrowUp,  faGripLines,  faLink, faPlus, faRemove, faTrash } from "@fortawesome/free-solid-svg-icons";
            ...
            setLinks(prevLinks=>{
                ...
                newLinks.forEach((link,index)=>{
                    if(link.key===linkKeyForUpload){
                        link.icon=uploadedImageUrl.data;
                    }
                });
                return newLinks;
            });
        ...
        <SectionBox>
            ...
            <form action={save}>
                ...
                <div className="" >
                    ...
                    {
                        links.map(l => (
                            <div key={l.key} className="mt-8 flex items-center gap-6 ">
                                ...
                                <div className="text-center">
                                    <div className="bg-gray-300 relative aspect-square overflow-hidden w-16 h-16 flex justify-center items-center">
                                        {l.icon && (
                                            <Image 
                                    ...
                                    <div>
                                        <input 
                                            ...
                                            className="hidden"
                                        />
                                        <label htmlFor={'icon'+l.key} className="border text-gray-600 p-2 mt-2 flex items-center gap-1 cursor-pointer mb-2 justify-center">
